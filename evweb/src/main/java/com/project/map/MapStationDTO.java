...
public class MapStationDTO {
	...
	private String charging_amount; // 충전량
	
	
	public MapStationDTO() {}


	public MapStationDTO(String station_id, String station_name, String addr_do, String addr_sigun,
			...
			String quick, String superQuick, String nonmem, String charging_amount) {
		super();
	...
	public String toString() {
		return "MapStationDTO [station_id=" + station_id + ", station_name=" + station_name
				...
				+ quick + ", superQuick=" + superQuick + ", nonmem=" + nonmem + ", charging_amount=" + charging_amount + "]";
	}
	...
	public void setCharging_amount(String cgAmount) {
		this.charging_amount = cgAmount;
	}
