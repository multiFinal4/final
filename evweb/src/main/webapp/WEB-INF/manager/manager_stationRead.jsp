...
<html>
	...
	<body>
		<div class="row">
			...
			<div class="card-body stationWrap col-lg-12">
				<form action="/evweb/manager/station/read.do?stationId=${read.station_id}&state=UPDATE" method="post">
					<div class="row mb-3">
	...
	<script type="text/javascript">
		$(document).ready(function () {
			...
			$("#delBtn").click(function () {
				$(".alertPop .modal").removeClass("show");
				location.href='/evweb/manager/station/delete.do?stationId=${read.station_id}';
			});
