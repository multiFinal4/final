...
<body>
	<div class="cmp-dfs-slider hr1-fct">
		...
		<div class="row" style="float: right;">
			...
			<h5 class="sym-btn txt-only"
				style="float: right; width: 350px; margin-left: 5px; padding-left: 5px; padding-right: 5px;"><%=weatherlist.get(0).getLocation_name()%></h5>
			<button type="button"
	...
	<div style="display: flex; justify-content: center;">
		...
		<div class="forecast-body"
			style="font-family: &amp; quot;Noto Serif&amp;quot;, Cambria, &amp;quot;Palatino Linotype&amp;quot;, &amp;quot;Book Antiqua&amp;quot;, &amp;quot;URW Palladio L&amp;quot;, serif; ">
				...
				<tr class="wf-row-pm25">
					...
					<td style="padding: px 1px 0px 0px;">
						<div style="display: inline-block; width: 80px;">
							<svg width="80px" height="80px" version="1.1" viewBox="0 0 64 52"
