							...
							<div class="forecast-body-summary">
								<table>
											...
											<td style="padding: px 1px 0px 0px;">
												<div style="display: inline-block; width: 80px;">
													<svg width="80px" height="80px" version="1.1"
														...
														<g>
														<c:choose>
											<c:when test="${dust.pm25value==-1}">
												<c:choose>
													<c:when test="${dust.pm10value==-1}">
														<path fill="#d1d5d9"
													...
													<c:when test="${dust.pm10value<=30}">
														<path fill="#099d6e"
															d="M47.165,51.322H16.834c-7.142,0-12.952-5.81-12.952-12.952c0-6.042,4.264-11.29,10.076-12.615 c-0.025-0.298-0.036-0.584-0.036-0.861c0-6.736,5.479-12.216,12.215-12.216c4.756,0,8.986,2.697,11.01,6.941 c5.152-0.822,9.957,1.677,12.398,6.033c6.063,1.131,10.571,6.503,10.571,12.718C60.117,45.513,54.308,51.322,47.165,51.322z"></path>
													</c:when>
													<c:when test="${dust.pm10value<=80}">
														<path fill="#fbde3d"
															d="M47.165,51.322H16.834c-7.142,0-12.952-5.81-12.952-12.952c0-6.042,4.264-11.29,10.076-12.615 c-0.025-0.298-0.036-0.584-0.036-0.861c0-6.736,5.479-12.216,12.215-12.216c4.756,0,8.986,2.697,11.01,6.941 c5.152-0.822,9.957,1.677,12.398,6.033c6.063,1.131,10.571,6.503,10.571,12.718C60.117,45.513,54.308,51.322,47.165,51.322z"></path>
													</c:when>
													<c:when test="${dust.pm10value<=150}">
														<path fill="#fb9c3d"
															d="M47.165,51.322H16.834c-7.142,0-12.952-5.81-12.952-12.952c0-6.042,4.264-11.29,10.076-12.615 c-0.025-0.298-0.036-0.584-0.036-0.861c0-6.736,5.479-12.216,12.215-12.216c4.756,0,8.986,2.697,11.01,6.941 c5.152-0.822,9.957,1.677,12.398,6.033c6.063,1.131,10.571,6.503,10.571,12.718C60.117,45.513,54.308,51.322,47.165,51.322z"></path>
													</c:when>
													<c:when test="${dust.pm10value>=151}">
														<path fill="#cb0b3d"
															d="M47.165,51.322H16.834c-7.142,0-12.952-5.81-12.952-12.952c0-6.042,4.264-11.29,10.076-12.615 c-0.025-0.298-0.036-0.584-0.036-0.861c0-6.736,5.479-12.216,12.215-12.216c4.756,0,8.986,2.697,11.01,6.941 c5.152-0.822,9.957,1.677,12.398,6.033c6.063,1.131,10.571,6.503,10.571,12.718C60.117,45.513,54.308,51.322,47.165,51.322z"></path>
													</c:when>
												</c:choose>	
									...
									<tr>
										...
										<c:forEach items="${airqualityInfo}" var="dust">
											<td>
												<c:if test="${dust.pm25value==-1}"><pm10box style="">-</pm10box></c:if>		
												<c:if test="${dust.pm25value!=-1}"><pm10box style="">${dust.pm25value}</pm10box></c:if>		
											</td>
										</c:forEach>
									</tr>
									<tr>
										...
										<c:choose>
											<c:when test="${dust.pm10value==-1}"><pm10box style="background-color:#d1d5d9;">-</pm10box></c:when>
